...
namespace HochschuleBremen\Application\SequenceAlignment\Model\Nucleobase;

use FlorianWolters\Component\Core\Enum\EnumAbstract;

/**
 * The base enumeration for nucleotype bases that are common to DNA and RNA.
 *
 * @category   Biology
 * @package    Sequence
 * @subpackage Compound
